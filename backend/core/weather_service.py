...
class WeatherService:
    ...
    def get_current_sanctuary_weather():
        try:
            ...
            url = f"https://api.open-meteo.com/v1/forecast?latitude={WeatherService.LAT}&longitude={WeatherService.LON}&current=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code,wind_speed_10m&wind_speed_unit=kmh&timezone=Africa%2FNairobi"
